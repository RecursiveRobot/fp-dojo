var _         = require ('ramda');
var interpret = require ('../lib/interpret.js');
...
describe ("Interpret test suite", function () {
    ...
    it ("Score of a randomly selected sentence.", function () {
        assert.equal (interpret.score ({gutenberg: 1, '.': 1 },
                                       {ForbesThis: 1,
                                        eBook: 1,
                                        is: 1,
                                        for: 1,
                                        ...
                                        whatsoever: 1,
                                        '.': 1 }), 4.47213595499958);
        assert.equal (interpret.score ({'This': 1,
                                        'eBook': 1,
                                        'is': 1,
                                        'for': 1,
                                        'the': 1,
